...
int main(int argc, char **argv) {
  ...
  while (wb_robot_step(timestep) != -1) {
    ...
    // Concurrent command execution - binary array format
    // Array positions: [0,1,2,3,4,5,6,7,8]
    // 1 = command active, 0 = command inactive
    const int active_commands[] = {1, 0, 1, 0, 1, 0, 0, 0, 0};
